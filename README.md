...
- Metrics endpoint (`/api/stats.php`) stores server snapshots in MySQL (`server_stats`) and returns up to the latest 120 stored samples so historical data still appears after reconnects.
